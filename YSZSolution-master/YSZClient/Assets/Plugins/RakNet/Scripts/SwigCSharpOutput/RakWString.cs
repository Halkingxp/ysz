...
public class RakWString : IDisposable {
  ...
  public RakWString(string input) : this(RakNetPINVOKE.new_RakWString__SWIG_4(input), true) {
  }

  public SWIGTYPE_p_wchar_t C_String() {
    IntPtr cPtr = RakNetPINVOKE.RakWString_C_String(swigCPtr);
  ...
  public RakWString CopyData(string str) {
    RakWString ret = new RakWString(RakNetPINVOKE.RakWString_CopyData__SWIG_4(swigCPtr, str), false);
    return ret;
  }

...
public static class CustomGenConfig
{
    ...
    public static List<Type> LuaCallCSharp = new List<Type>() {
                ...
                typeof(TabControl),
                typeof(PageCurl),
                typeof(CutDeckControl),
                typeof(LoadingDataUI),
                typeof(UILoading),
                typeof(LuaAsynFuncMgr),
                typeof(SystemInfo),
                typeof(PlatformBridge),
                typeof(UnityEngine.Random),
                typeof(AppDefineConst),
            };
    ...
    public static List<Type> CSharpCallLua = new List<Type>() {
                ...
                typeof(Action<Net.PopMessage>),
                typeof(Action<WindowNode>),
